-- ============================================
-- Missing Indexes for Staff Tables
-- ============================================
-- This script adds all missing indexes from migration 1731353000000-AddStaffIndexes
-- These indexes are CRITICAL for query performance, especially the JOIN operations
-- ============================================
