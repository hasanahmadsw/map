...
/**
 * Migration to recreate all staff table indexes
 * This migration ensures indexes are recreated if they were dropped by synchronize
 * Run this after disabling synchronize to restore all performance indexes
 */
export class RecreateStaffIndexes1731356000000 implements MigrationInterface {
